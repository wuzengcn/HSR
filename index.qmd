...
- It dates back to [World Health Report 2000]{.red}, which defines health system as “all the activities whose primary purpose is to promote, restore or maintain health” (WHO, 2000)
...
:::
:::{.column width="50%"}
![](pic/WHO-2000.png){.center width="100%"}
:::
::::
...
## Some key research questions in health system research
...
## General information and achievement in Afghansitan
...
- Achievements 
    ...
    - Life expectancy: 56 (2002) to 66 years (2023)
    - Infant mortality rate: from 104 (2002) to 50 (2023) per 1000 live births
    - Maternal mortality ratio: from 1263 (2002) to 521 (2023) per 100,000 live births
...
- Not sustainable, and not equitable (NHA 2021)
  ...
  - Low level of government spending (3.3%)

  - Donor funding anticipated to decline (19.5%)

  - Substantial share of out of pocket (OOP) spending (77.2%)

  - Low executiion of existing government budget for health 

:::

:::{.column width="50%"}
![](pic/p11.JPG){.center width="80%"}
:::
::::
...
- Tracking health expenditure
    - National health accounts (NHA)
    - Public Expenditure Traciing Survey
    - Expenditure managment Information systems 
...
:::
:::{.column width="50%"}
![](pic/HF-strategy.png){.center width="70%"}
:::
::::

--- 

## Health financing strategy in action

:::: columns
:::{.column width="50%"}
- Amended the health law in 2016
...
- Developed and passed the user fee regulation
- BPHS/EPHS to transition from contract management to performance
management
:::
:::{.column width="50%"}
![](pic/Tobacco-v2.jpg){.center width="100%"}
:::
::::

---

## Health insurance accomplishments 

- Conducted First phase of health insurance feasiblity study (2014-2015)
- Conducted second phase of health insurance feasibility study (2018-2020)
    - Willingness and ability to pay for health insurance
    - Benefit package design for health insurance
    - Actuary analysis for health insurance
- Developed the health insurance policy (2016)
- Drafted the health insruance law (2019)
- Developed a health insurance policy for civil servants (2017)
...
- Overall global instability, which makes it difficult to generate revenue and implement health reform in the country
    - Russia-Ukraine war
    - Gaza-Israel war
    - US-Iran tension
...
## Future of health system research 
...
:::
:::{.column width="50%"}
![](pic/Future.png){.center width="80%"}
:::
::::
...
- Health system research is underdeveloped but critical to improving health outcomes and achieving UHC
- Health system research is a multidisciplinary field that draws on a variety of disciplines to understand how health systems function and how they can be improved
- Health system research is witnessing great changes in the context of global health
